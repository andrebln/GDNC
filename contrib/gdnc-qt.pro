...
RESOURCES += src/qt/gdnc.qrc src/qt/gdnc_locale.qrc

TRANSLATIONS += src/qt/locale/gdnc_bg.ts \
                src/qt/locale/gdnc_de.ts \
                src/qt/locale/gdnc_en.ts \
                src/qt/locale/gdnc_es.ts \
                src/qt/locale/gdnc_fi.ts \
                src/qt/locale/gdnc_fr.ts \
                src/qt/locale/gdnc_it.ts \
                src/qt/locale/gdnc_ja.ts \
                src/qt/locale/gdnc_pl.ts \
                src/qt/locale/gdnc_pt.ts \
                src/qt/locale/gdnc_ru.ts \
                src/qt/locale/gdnc_sk.ts \
                src/qt/locale/gdnc_sv.ts \
                src/qt/locale/gdnc_vi.ts \
                src/qt/locale/gdnc_zh_CN.ts \
                src/qt/locale/gdnc_zh_TW.ts
