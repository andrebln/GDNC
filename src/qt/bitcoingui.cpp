                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("GDNC-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GDNC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and gdnc: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Guardian Core"), this);
    aboutAction->setStatusTip(tr("Show information about Guardian Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GDNC"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GDNC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GDNC addresses"));
    ...
    openAction->setStatusTip(tr("Open a GDNC: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Guardian Core help message to get a list with possible GDNC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Guardian Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GDNC network", "", count));
}
...
{
    QString strTitle = tr("Guardian Core"); // default title
