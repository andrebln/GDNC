...
private:
    ...
    /// Get 10000 GDNC input that can be used for the Masternode
...
{
public:
    /// Is the inputs associated with this public key? (and there is 10000 GDNC - checking if valid masternode)
