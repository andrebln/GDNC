...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Guardian Core gdnc-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  gdnc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gdnc transaction") + "\n" +
                               "  gdnc-tx [options] -create [commands]   " + _("Create hex-encoded gdnc transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded gdnc transaction
