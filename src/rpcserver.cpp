...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* GDNC features */
        {"gdnc", "masternode", &masternode, true, true, false},
        {"gdnc", "masternodelist", &masternodelist, true, true, false},
        {"gdnc", "mnbudget", &mnbudget, true, true, false},
        {"gdnc", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"gdnc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"gdnc", "mnsync", &mnsync, true, true, false},
        {"gdnc", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use gdncd, or the -server option to gdnc-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> gdnc-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:47210/\n";
}
