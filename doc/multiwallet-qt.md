...
In order to support loading of multiple wallets in gdnc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is gdnc.cpp.
...
Changes to gdnc.cpp
----------------------
gdnc.cpp is the entry point into gdnc-qt, and as such, will require some minor modifications to provide hooks for
